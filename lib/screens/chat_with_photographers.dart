...
class ChatWithPhotographers extends StatefulWidget {
  const ChatWithPhotographers({super.key});

  @override
  State<ChatWithPhotographers> createState() => _ChatWithPhotographersState();
}

class _ChatWithPhotographersState extends State<ChatWithPhotographers> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Photographers You Messaged'),
            ...
            itemBuilder: (context, index) {
              ...
              return FutureBuilder<DocumentSnapshot>(
                ...
                builder: (context, userSnapshot) {
                  ...
                  final displayName = userData['name'] ?? 'Photographer';
